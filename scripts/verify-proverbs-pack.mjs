...
const PREFIXES = [
  ...
  'proverbs-earring-nose',
  'proverbs-rice-cake-picture',
  'proverbs-diamond-food',
  'proverbs-run-before-crawl',
  'proverbs-long-tail',
  'proverbs-crow-fly-belly',
  'proverbs-pheasant-chicken',
  'proverbs-pheasant-egg',
  'proverbs-others-cake',
  'proverbs-sickle-giyeok',
  'proverbs-day-bird-night-mouse',
  'proverbs-nose-three-feet',
  'proverbs-lie-rice-cake',
  'proverbs-lie-spit',
